...
<?php $__currentLoopData = $heroImageUrls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<link rel="preload" href="<?php echo e($imageUrl); ?>" as="image">
...
<a href="<?php echo e(route('user.cart.index')); ?>" class="cart-floating-button">
    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
    </svg>
    <span id="cart-counter" class="cart-counter"><?php echo e($cartItemCount); ?></span>
</a>
...
<section
    x-data="{
        heroImages: <?php echo e(json_encode($heroImageUrls)); ?>,
        currentBg: 0,
        nextBg: 1,
        frontLayer: true,
        interval: null,
    ...
    <div class="relative z-30 px-4 mx-auto max-w-7xl">
            ...
            <div class="banner-section">
                <div class="banner-image-container">
                    <img src="<?php echo e(asset($banner->image)); ?>"
                         alt="<?php echo e($banner->title ?? 'Promo Tanaman Hias Juli'); ?>"
                         class="banner-image"
                         loading="lazy" />
                    <div class="banner-overlay">
                        <div class="banner-content">
                            <h2 class="banner-title"><?php echo e($banner->title ?? 'Promo Tanaman Hias Juli'); ?></h2>
                        </div>
        ...
        <div class="search-filter-container">
            <div class="grid gap-4 md:grid-cols-2">
                <form method="GET" action="<?php echo e(route('products.index')); ?>" class="space-y-3">
        ...
        <?php if($promo_code && $promo_type !== null && $promo_discount !== null): ?>
            <div class="promo-active-notification">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="font-semibold text-green-800">Promo aktif: <span class="font-mono"><?php echo e($promo_code); ?></span></p>
                        <p class="text-sm text-green-700">
                            Diskon <?php echo e($promo_type === 'percent' ? $promo_discount_percent . '%' : 'Rp ' . number_format($promo_discount, 0, ',', '.')); ?>
        ...
        <div class="mb-12 product-grid">
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="overflow-hidden product-card rounded-xl">
                    ...
                    <div class="p-5">
                        <h2 class="mb-2 text-xl font-semibold text-gray-800 line-clamp-2"><?php echo e($product->name); ?></h2>
                        <p class="mb-4 text-sm text-gray-600 line-clamp-2"><?php echo e(Str::limit($product->description, 80)); ?></p>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <form method="POST" action="<?php echo e(route('user.cart.add')); ?>" class="add-to-cart-form">
                                    ...
                                    <input type="hidden" name="price" value="<?php echo e($final_price); ?>">
                                    <button type="submit"
    ...
    document.querySelectorAll('.add-to-cart-form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            if (!formData.get('promo_code')) {
                formData.set('promo_code', '<?php echo e(session('promo_code') ?? ''); ?>');
            }
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    setTimeout(() => window.location.href = "/user/cart", 900);
                } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\azka-garden\resources\views/products/index.blade.php ENDPATH**/ ?>