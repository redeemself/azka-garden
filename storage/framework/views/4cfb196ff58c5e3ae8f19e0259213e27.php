    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <figure class="relative mb-4 overflow-hidden transition bg-white border border-green-100 rounded-lg shadow hover:shadow-lg">
                <img src="<?php echo e(asset($img)); ?>" alt="Azka Garden <?php echo e($i+1); ?>" class="object-cover w-full h-48 sm:h-56 md:h-64" loading="lazy">
...
<?php /**PATH C:\laragon\www\azka-garden\resources\views/components/gallery.blade.php ENDPATH**/ ?>