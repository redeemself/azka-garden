<?php $__env->startSection('title', 'Kontak Kami - Azka Garden'); ?>
...
<div class="container max-w-6xl px-4 py-12 mx-auto">
  ...
  <div class="flex flex-col gap-12 md:flex-row">
    ...
    <div class="md:w-1/2">
      ...
      <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="relative p-6 space-y-6 bg-white border border-green-200 shadow-md rounded-xl" novalidate>
        <?php echo csrf_field(); ?>

        
        <div>
          <label for="name" class="block mb-2 font-semibold text-green-800">Nama Lengkap</label>
          <input id="name" name="name" type="text" autocomplete="name" value="<?php echo e(old('name')); ?>" required
            class="w-full rounded-md p-3 text-green-900 placeholder-green-400 focus:outline-none focus:ring-2 focus:ring-green-500 border <?php echo e($errors->has('name') ? 'border-red-500' : 'border-green-300'); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input id="email" name="email" type="email" autocomplete="email" value="<?php echo e(old('email')); ?>" required
            class="w-full rounded-md p-3 text-green-900 placeholder-green-400 focus:outline-none focus:ring-2 focus:ring-green-500 border <?php echo e($errors->has('email') ? 'border-red-500' : 'border-green-300'); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input id="phone" name="phone" type="tel" autocomplete="tel" value="<?php echo e(old('phone')); ?>"
            class="w-full rounded-md p-3 text-green-900 placeholder-green-400 focus:outline-none focus:ring-2 focus:ring-green-500 border <?php echo e($errors->has('phone') ? 'border-red-500' : 'border-green-300'); ?>"
        ...
        <div class="relative">
          ...
          <div class="relative textarea-wrap">
            <textarea id="message" name="message" autocomplete="off" rows="5" required
              class="w-full rounded-md p-3 text-green-900 placeholder-green-400 focus:outline-none focus:ring-2 focus:ring-green-500 border <?php echo e($errors->has('message') ? 'border-red-500' : 'border-green-300'); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\azka-garden\resources\views/contact.blade.php ENDPATH**/ ?>