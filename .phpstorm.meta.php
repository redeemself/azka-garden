...
'shipping.costs.JNT','shipping.costs.GOSEND','shipping.costs.JNE','shipping.costs.SICEPAT','shipping.costs.KURIR_TOKO_DEKAT',
'shipping.costs.KURIR_TOKO','shipping.costs.KURIR_TOKO_JAUH','shipping.costs.AMBIL_SENDIRI','shipping.kurir_toko_costs.less_than_5km','shipping.kurir_toko_costs.5_to_10km',
'shipping.kurir_toko_costs.more_than_10km','shipping.store_location.name','shipping.store_location.address','shipping.store_location.latitude','shipping.store_location.longitude',
'shipping.method_labels.JNT','shipping.method_labels.GOSEND','shipping.method_labels.JNE','shipping.method_labels.SICEPAT','shipping.method_labels.KURIR_TOKO_DEKAT',
'shipping.method_labels.KURIR_TOKO','shipping.method_labels.KURIR_TOKO_JAUH','shipping.method_labels.AMBIL_SENDIRI','shipping.service_names.JNT','shipping.service_names.GOSEND',
'shipping.service_names.JNE','shipping.service_names.SICEPAT','shipping.service_names.KURIR_TOKO_DEKAT','shipping.service_names.KURIR_TOKO','shipping.service_names.KURIR_TOKO_JAUH',
'shipping.service_names.AMBIL_SENDIRI','shipping.defaults.method','shipping.defaults.cost','shipping.defaults.free_shipping_threshold','shipping.defaults.tax_rate',
'shipping.updated_at','shipping.updated_by','sanctum.stateful','sanctum.guard','sanctum.expiration',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','home','about','contact','contact.submit',
'products.index','products.category','services.index','faq','products.show',
...
'promo.activate','promo.deactivate','register','register.submit','login',
'login.user.submit','logout','products.like','products.comment','address.store',
'address.updateCoords','user.orders.expire','user.orders.cancel','user.orders.complete','checkout.index',
'checkout.process','user.home','user.profile.index','user.profile.edit','user.profile.update',
'user.confirmRoles','user.addresses.index','user.addresses.create','user.addresses.store','user.addresses.edit',
'user.addresses.update','user.addresses.destroy','user.addresses.setPrimary','user.products.index','user.products.redeem.form',
'user.products.redeem','user.products.show','user.cart.index','user.cart.add','user.cart.update',
'user.cart.destroy','user.cart.redeem','user.cart.apply-promo','user.cart.save-shipping','user.cart.save-payment',
'user.payment.index','user.payment.store','user.payment.process','user.payment.success','user.payment.failed',
'user.orders.index','user.orders.history.index','user.orders.create','user.orders.checkout.success','user.orders.show',
'user.orders.pay','user.orders.cancel','user.orders.expire','user.orders.complete','user.orders.finish',
'user.orders.cancelConfirm','user.orders.cancel-draft','user.orders.clear_expired','admin.login','admin.login.submit',
'admin.register','admin.register.submit','admin.dashboard','admin.profile','admin.profile.edit',
'admin.profile.update','admin.logout','dev.register','dev.register.submit','dev.login',
'dev.login.submit','dev.dashboard','dev.profile','dev.profile.update','dev.logout',
'error.401','error.403','error.404','error.419','error.422',
'error.429','error.500','error.503','storage.local',);
        registerArgumentsSet('views', 
'User.cart','User.orders.confirm','User.orders.history','User.orders.index','User.orders.pay',
'User.orders.show','User.payment.index','User.products.index','User.products.show','User.profile.index',
'User.profile.script','about','admin.dashboard','admin.login','admin.profile.edit',
'admin.profile.index','admin.register','artikel._referensi','artikel.index','auth.login',
'auth.register','blog.index','checkout','components.alert','components.confirm-modal',
'components.faq_list','components.gallery','components.input','components.login-background','components.models',
'components.services','contact','emails.contact','emails.contact_from','emails.contact_message',
'emails.promo','errors.401','errors.403','errors.404','errors.419',
'errors.422','errors.429','errors.500','errors.503','faq',
'home','layouts.app','membership.index','orders.index','partials.footer',
'partials.header','partials.navbar','policies.accessibility','policies.cookies','policies.notice',
'policies.privacy','policies.reset_confirmation','policies.return','policies.terms','products.index',
'services.index','sitemap','sitemap.xml','sitemap.xml','l5-swagger::index',
...
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','CACHE_DRIVER',
'SESSION_DRIVER','SESSION_LIFETIME','QUEUE_CONNECTION','BROADCAST_DRIVER','FILESYSTEM_DISK',
'MAIL_MAILER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_DEV_SERVER_HOST','VITE_DEV_SERVER_PORT',
'VITE_DEV_SERVER_URL','VITE_APP_NAME','GOOGLE_API_KEY','GOOGLE_CSE_ID',);
