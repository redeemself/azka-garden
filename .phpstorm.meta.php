...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.developer.driver' => 'string',
            'auth.guards.developer.provider' => 'string',
            ...
            'auth.providers.developers.driver' => 'string',
            'auth.providers.developers.model' => 'string',
            ...
            'auth.passwords.developers.provider' => 'string',
            'auth.passwords.developers.table' => 'string',
            'auth.passwords.developers.expire' => 'integer',
            'auth.passwords.developers.throttle' => 'integer',
            ...
            'filesystems.links.C:\laragon\www\azka-garden\public\storage' => 'string',
            ...
            'l5-swagger.documentations.default.paths.views' => 'string',
            'l5-swagger.documentations.default.paths.base' => 'NULL',
            'l5-swagger.documentations.default.paths.swagger_ui_assets_path' => 'NULL',
            'l5-swagger.documentations.default.generate_always' => 'boolean',
            'l5-swagger.documentations.default.swagger_version' => 'string',
            'l5-swagger.documentations.default.proxy' => 'boolean',
            ...
            'services.googlemaps.key' => 'string',
            ...
            'shipping.costs.JNT' => 'double',
            'shipping.costs.GOSEND' => 'double',
            'shipping.costs.JNE' => 'double',
            'shipping.costs.SICEPAT' => 'double',
            'shipping.costs.KURIR_TOKO_DEKAT' => 'double',
            'shipping.costs.KURIR_TOKO' => 'double',
            'shipping.costs.KURIR_TOKO_JAUH' => 'double',
            'shipping.costs.AMBIL_SENDIRI' => 'double',
            'shipping.kurir_toko_costs.less_than_5km' => 'double',
            'shipping.kurir_toko_costs.5_to_10km' => 'double',
            'shipping.kurir_toko_costs.more_than_10km' => 'double',
            'shipping.store_location.name' => 'string',
            'shipping.store_location.address' => 'string',
            'shipping.store_location.latitude' => 'double',
            'shipping.store_location.longitude' => 'double',
            'shipping.method_labels.JNT' => 'string',
            'shipping.method_labels.GOSEND' => 'string',
            'shipping.method_labels.JNE' => 'string',
            'shipping.method_labels.SICEPAT' => 'string',
            'shipping.method_labels.KURIR_TOKO_DEKAT' => 'string',
            'shipping.method_labels.KURIR_TOKO' => 'string',
            'shipping.method_labels.KURIR_TOKO_JAUH' => 'string',
            'shipping.method_labels.AMBIL_SENDIRI' => 'string',
            'shipping.service_names.JNT' => 'string',
            'shipping.service_names.GOSEND' => 'string',
            'shipping.service_names.JNE' => 'string',
            'shipping.service_names.SICEPAT' => 'string',
            'shipping.service_names.KURIR_TOKO_DEKAT' => 'string',
            'shipping.service_names.KURIR_TOKO' => 'string',
            'shipping.service_names.KURIR_TOKO_JAUH' => 'string',
            'shipping.service_names.AMBIL_SENDIRI' => 'string',
            'shipping.defaults.method' => 'string',
            'shipping.defaults.cost' => 'double',
            'shipping.defaults.free_shipping_threshold' => 'integer',
            'shipping.defaults.tax_rate' => 'double',
            'shipping.updated_at' => 'string',
            'shipping.updated_by' => 'string',
...
'auth.guards.web.driver','auth.guards.web.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.developer.driver',
'auth.guards.developer.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.admins.driver','auth.providers.admins.model','auth.providers.developers.driver','auth.providers.developers.model','auth.passwords.users.provider',
...
'auth.passwords.admins.expire','auth.passwords.admins.throttle','auth.passwords.developers.provider','auth.passwords.developers.table','auth.passwords.developers.expire',
'auth.passwords.developers.throttle','auth.password_timeout','cache.default','cache.stores.array.driver','cache.stores.array.serialize',
...
'filesystems.links.C:\\laragon\\www\\azka-garden\\public\\storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.annotations',
'l5-swagger.documentations.default.paths.docs_json','l5-swagger.documentations.default.paths.docs_yaml','l5-swagger.documentations.default.paths.views','l5-swagger.documentations.default.paths.base','l5-swagger.documentations.default.paths.swagger_ui_assets_path',
'l5-swagger.documentations.default.generate_always','l5-swagger.documentations.default.swagger_version','l5-swagger.documentations.default.proxy','l5-swagger.defaults.routes.docs','l5-swagger.defaults.routes.oauth2_callback',
...
'logging.channels.stderr.driver','logging.channels.stderr.handler','logging.channels.stderr.with.stream','logging.channels.stderr.level','logging.channels.syslog.driver',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.googlemaps.key',
...
'session.partitioned','shipping.costs.JNT','shipping.costs.GOSEND','shipping.costs.JNE','shipping.costs.SICEPAT',
'shipping.costs.KURIR_TOKO_DEKAT','shipping.costs.KURIR_TOKO','shipping.costs.KURIR_TOKO_JAUH','shipping.costs.AMBIL_SENDIRI','shipping.kurir_toko_costs.less_than_5km',
'shipping.kurir_toko_costs.5_to_10km','shipping.kurir_toko_costs.more_than_10km','shipping.store_location.name','shipping.store_location.address','shipping.store_location.latitude',
'shipping.store_location.longitude','shipping.method_labels.JNT','shipping.method_labels.GOSEND','shipping.method_labels.JNE','shipping.method_labels.SICEPAT',
'shipping.method_labels.KURIR_TOKO_DEKAT','shipping.method_labels.KURIR_TOKO','shipping.method_labels.KURIR_TOKO_JAUH','shipping.method_labels.AMBIL_SENDIRI','shipping.service_names.JNT',
'shipping.service_names.GOSEND','shipping.service_names.JNE','shipping.service_names.SICEPAT','shipping.service_names.KURIR_TOKO_DEKAT','shipping.service_names.KURIR_TOKO',
'shipping.service_names.KURIR_TOKO_JAUH','shipping.service_names.AMBIL_SENDIRI','shipping.defaults.method','shipping.defaults.cost','shipping.defaults.free_shipping_threshold',
'shipping.defaults.tax_rate','shipping.updated_at','shipping.updated_by','sanctum.stateful','sanctum.guard',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','home','services.index','about','contact',
'contact.submit','products.index','faq','products.show','products.add-to-cart',
'blog.index','blog.search','artikel.index','sitemap.html','sitemap.xml',
'newsletter.subscribe','membership.index','privacy','terms','cookies',
'return.policy','accessibility','policy.accept','policy.reset.form','policy.reset',
'promo.activate','promo.deactivate','register',
'register.submit','login','login.user.submit','logout','cart.index',
'user.cart.index','cart.add','cart.update','user.cart.update','cart.remove',
'user.cart.remove','cart.clear','user.cart.clear','user.cart.apply-promo','cart.redeem-promo',
'user.cart.remove-promo','cart.select-shipping','cart.save-shipping','cart.prepare-checkout','checkout.index',
'checkout.prepare','checkout.process','checkout.confirm','checkout.success','checkout.failed',
'products.like','products.comment','user.address.index','user.address.create','user.address.store',
'user.address.edit','user.address.update','user.address.destroy','user.address.setPrimary','address.updateCoords',
'user.orders.expire.global','user.orders.cancel.global','user.orders.complete.global','user.orders.history.index','user.orders.show',
'storage.local',);
        registerArgumentsSet('views', 
'User.address.create','User.address.index','User.cart','User.checkout','User.orders.history',
'User.orders.index','User.orders.show','User.payment.index','User.products.index','User.products.show',
'User.profile.index','User.profile.script','about','admin.dashboard','admin.login',
'admin.profile.edit','admin.profile.index','admin.register','artikel._referensi','artikel.index',
'auth.login','auth.register','blog.index','components.alert','components.confirm-modal',
'components.faq_list','components.gallery','components.input','components.login-background','components.models',
'components.services','contact','debug','emails.contact','emails.contact_from',
'emails.contact_message','emails.promo','errors.401','errors.403','errors.404',
'errors.419','errors.422','errors.429','errors.500','errors.503',
'faq','home','layouts.app','membership.index','orders.index',
'partials.footer','partials.header','partials.navbar','policies.accessibility','policies.cookies',
'policies.notice','policies.privacy','policies.reset_confirmation','policies.return','policies.terms',
'products.index','services.index','sitemap','sitemap.xml','sitemap.xml',
...
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.azka-garden.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'APP_MAINTENANCE_STORE','BCRYPT_ROUNDS','PHP_CLI_SERVER_WORKERS','LOG_CHANNEL','LOG_STACK',
...
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','SESSION_SECURE_COOKIE','SESSION_HTTP_ONLY',
'SESSION_SAME_SITE','CACHE_STORE','CACHE_PREFIX','CACHE_DEFAULT_TTL','QUEUE_CONNECTION',
'QUEUE_FAILED_DRIVER','BROADCAST_CONNECTION','BROADCAST_DRIVER','FILESYSTEM_DISK','FILESYSTEM_CLOUD',
'MEMCACHED_HOST','MEMCACHED_PORT','MEMCACHED_USERNAME','MEMCACHED_PASSWORD','REDIS_CLIENT',
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_DB','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_ENCRYPTION',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_BACKUP_HOST','MAIL_BACKUP_PORT','MAIL_BACKUP_USERNAME',
'MAIL_BACKUP_PASSWORD','GOOGLE_API_KEY','GOOGLE_CSE_ID','GOOGLE_MAPS_API_KEY','AWS_ACCESS_KEY_ID',
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_DEV_SERVER_HOST',
'VITE_DEV_SERVER_PORT','VITE_DEV_SERVER_URL','VITE_APP_NAME','VITE_APP_ENV','MIX_PUSHER_APP_KEY',
'MIX_PUSHER_APP_CLUSTER','MIDTRANS_MERCHANT_ID','MIDTRANS_CLIENT_KEY','MIDTRANS_SERVER_KEY','MIDTRANS_IS_PRODUCTION',
'MIDTRANS_IS_SANITIZED','MIDTRANS_IS_3DS','PAYPAL_CLIENT_ID','PAYPAL_CLIENT_SECRET','PAYPAL_MODE',
'WHATSAPP_TOKEN','WHATSAPP_PHONE_NUMBER_ID','WHATSAPP_VERIFY_TOKEN','TELEGRAM_BOT_TOKEN','TELEGRAM_CHAT_ID',
'CART_SESSION_LIFETIME','CART_ABANDON_TIMEOUT','CART_MAX_ITEMS','SHIPPING_DEFAULT_METHOD','SHIPPING_FREE_MINIMUM',
'SHIPPING_CALCULATION_API','TAX_RATE','TAX_INCLUDED','INVENTORY_TRACK_QUANTITY','INVENTORY_ALLOW_BACKORDER',
'INVENTORY_LOW_STOCK_THRESHOLD','THROTTLE_LOGIN_ATTEMPTS','THROTTLE_LOGIN_DECAY_MINUTES','THROTTLE_API_REQUESTS','THROTTLE_CART_OPERATIONS',
'THROTTLE_CHECKOUT_OPERATIONS','SECURE_HEADERS_ENABLED','CONTENT_SECURITY_POLICY_ENABLED','AZKA_GARDEN_VERSION','AZKA_GARDEN_UPDATED',
'AZKA_GARDEN_USER','AZKA_GARDEN_ENV','STORE_NAME','STORE_DESCRIPTION','STORE_ADDRESS',
'STORE_PHONE','STORE_EMAIL','STORE_WEBSITE','STORE_LATITUDE','STORE_LONGITUDE',
'STORE_PLUS_CODE','STORE_OPEN_TIME','STORE_CLOSE_TIME','STORE_TIMEZONE','CURRENCY_CODE',
'CURRENCY_SYMBOL','CURRENCY_DECIMALS','CURRENCY_DECIMAL_SEPARATOR','CURRENCY_THOUSANDS_SEPARATOR','GOOGLE_ANALYTICS_ID',
'GOOGLE_TAG_MANAGER_ID','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE','TELESCOPE_ENABLED','DEBUGBAR_ENABLED',
'BACKUP_DISK','BACKUP_SCHEDULE','BACKUP_RETENTION_DAYS','MAINTENANCE_SECRET_KEY','FEATURE_CART_ABANDONMENT',
'FEATURE_WISHLIST','FEATURE_PRODUCT_REVIEWS','FEATURE_LOYALTY_PROGRAM','FEATURE_MULTI_VENDOR','FEATURE_ADVANCED_SEARCH',
'DEBUG_QUERIES','DEBUG_ROUTES','DEBUG_MIDDLEWARE','DEBUG_CART_OPERATIONS','TESTING_DATABASE',
'TESTING_CACHE_DRIVER','TESTING_SESSION_DRIVER','TESTING_QUEUE_CONNECTION',);
