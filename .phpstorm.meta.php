...
'products.index','products.category','services.index','products.show','products.like',
'products.comment','user.address.store','user.address.updateCoords','faq','sitemap.html',
'sitemap.xml','blog.index','blog.search','newsletter.subscribe','membership.index',
'privacy','terms','cookies','return.policy','accessibility',
'policy.accept','policy.reset','policy.reset.form','artikel.index','register',
'register.submit','login','login.user.submit','logout','user.home',
'user.profile.index','user.profile.edit','user.profile.update','user.confirmRoles','user.products.index',
'user.products.redeem.form','user.products.redeem','user.products.show','user.cart.index','user.cart.add',
'user.cart.update.fallback','user.cart.delete.fallback','user.cart.redeem','user.cart.save-shipping','user.cart.save-payment',
'user.cart.update.put','user.cart.delete.delete','user.orders.index','user.orders.history.index','user.orders.show',
'user.orders.create','user.orders.cancel','user.orders.cancel','user.orders.confirm','user.orders.pay',
'user.orders.cancelConfirm','user.orders.clear_expired','user.orders.finish','user.orders.cancel-draft','user.orders.expire',
'user.orders.complete','user.address.index','user.address.update','user.address.destroy','user.address.setPrimary','promo.activate','promo.deactivate','admin.login',
'admin.login.submit','admin.register','admin.register.submit','admin.dashboard','admin.profile',
'admin.profile.edit','admin.profile.update','admin.logout','dev.register','dev.register.submit',
'dev.login','dev.login.submit','dev.dashboard','dev.profile','dev.profile.update',
'dev.logout','error.401','error.403','error.404','error.419',
'error.422','error.429','error.500','error.503',
'storage.local',);
        registerArgumentsSet('views', 
'User.cart','User.orders.confirm','User.orders.history','User.orders.index','User.orders.pay',
'User.orders.show','User.products.index','User.products.show','User.profile.index','User.profile.script',
'about','admin.dashboard','admin.login','admin.profile.edit','admin.profile.index',
'admin.register','artikel._referensi','artikel.index','auth.login','auth.register',
'blog.index','components.alert','components.confirm-modal','components.faq_list','components.gallery',
'components.input','components.login-background','components.models','components.services','contact',
'emails.contact','emails.contact_from','emails.contact_message','emails.promo','errors.401',
'errors.403','errors.404','errors.419','errors.422','errors.429',
'errors.500','errors.503','faq','home','layouts.app',
'membership.index','orders.index','partials.footer','partials.header','partials.navbar',
'policies.accessibility','policies.cookies','policies.notice','policies.privacy','policies.reset_confirmation',
'policies.return','policies.terms','products.index','services.index','sitemap',
'sitemap.xml','sitemap.xml','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
