...
@section('title', 'Sitemap Website Azka Garden')
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
    ...
    <div class="bg-white border-2 border-green-200 rounded-xl shadow p-8 mb-10 flex justify-center overflow-x-auto">
      <svg viewBox="0 0 1000 540" width="950" height="440" class="max-w-full h-auto">
        ...
        <!-- Produk children -->
        <a xlink:href="{{ url('/products/category') }}">
        ...
        <a xlink:href="{{ url('/products/search') }}">
        ...
        <a xlink:href="{{ url('/accessibility') }}">
        ...
        <a xlink:href="{{ url('/return-policy') }}">
        ...
        <a xlink:href="{{ url('/artikel/search') }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
      ...
      <div class="bg-white border-2 border-green-200 rounded-xl shadow-sm p-6">
        ...
        <ul class="space-y-2 text-green-800 text-base">
          <li><a href="{{ url('/login') }}" class="hover:text-green-700 transition">Login</a></li>
          <li><a href="{{ url('/register') }}" class="hover:text-green-700 transition">Register</a></li>
          <li><a href="{{ url('/faq') }}" class="hover:text-green-700 transition">FAQ</a></li>
          <li><a href="{{ url('/privacy') }}" class="hover:text-green-700 transition">Privacy</a></li>
          <li><a href="{{ url('/terms') }}" class="hover:text-green-700 transition">Terms</a></li>
          <li><a href="{{ url('/contact') }}" class="hover:text-green-700 transition">Contact</a></li>
        </ul>
      </div>
      <!-- Customer -->
      <div class="bg-white border-2 border-green-200 rounded-xl shadow-sm p-6">
        ...
        <ul class="space-y-2 text-green-800 text-base">
          <li><a href="{{ url('/profile') }}" class="hover:text-green-700 transition">Profile</a></li>
          <li><a href="{{ url('/profile/orders') }}" class="hover:text-green-700 transition">Orders</a></li>
          <li><a href="{{ url('/profile/payments') }}" class="hover:text-green-700 transition">Payments</a></li>
          <li><a href="{{ url('/profile/shipping') }}" class="hover:text-green-700 transition">Shipping</a></li>
          <li><a href="{{ url('/profile/addresses') }}" class="hover:text-green-700 transition">Addresses</a></li>
          <li><a href="{{ url('/profile/reviews') }}" class="hover:text-green-700 transition">Reviews</a></li>
          <li><a href="{{ url('/cart') }}" class="hover:text-green-700 transition">Cart</a></li>
          <li><a href="{{ url('/checkout') }}" class="hover:text-green-700 transition">Checkout</a></li>
        </ul>
      </div>
      <!-- User -->
      <div class="bg-white border-2 border-green-200 rounded-xl shadow-sm p-6">
        ...
        <ul class="space-y-2 text-green-800 text-base">
          <li><a href="{{ url('/profile') }}" class="hover:text-green-700 transition">Profile</a></li>
          <li><a href="{{ url('/profile/edit') }}" class="hover:text-green-700 transition">Edit Profile</a></li>
          <li><a href="{{ url('/profile/orders') }}" class="hover:text-green-700 transition">Orders</a></li>
          <li><a href="{{ url('/profile/payments') }}" class="hover:text-green-700 transition">Payments</a></li>
          <li><a href="{{ url('/profile/shipping') }}" class="hover:text-green-700 transition">Shipping</a></li>
          <li><a href="{{ url('/profile/addresses') }}" class="hover:text-green-700 transition">Addresses</a></li>
