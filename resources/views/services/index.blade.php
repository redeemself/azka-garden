...
<section class="py-12 bg-green-50">
  <div class="px-4 mx-auto max-w-7xl sm:px-8"> {{-- Tambah lebar ke max-w-7xl --}}

    <h1 class="mb-10 text-3xl font-extrabold text-center text-green-800 md:text-4xl">
      Layanan Kami
    </h1>

    {{-- Garis artikel kiri-kanan --}}
    <div class="relative mx-auto max-w-7xl"> {{-- Garis dan grid sejajar dengan navbar --}}
    ...
    <div class="flex justify-center mt-16">
      <div class="flex flex-col items-center w-full max-w-md p-8 border border-green-100 shadow-lg bg-white/80 rounded-xl">
        ...
        <div class="flex justify-center w-full gap-3">
          ...
          <a href="{{ route('contact') }}" class="flex items-center justify-center flex-1 gap-2 px-0 py-0">
