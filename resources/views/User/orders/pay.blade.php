...
<div class="pay-container">
    ...
    <div id="pay-content">
        ...
        <div class="pay-summary">
            <div class="pay-status-badge">Status: {{ $displayStatus }}</div>
            <div class="pay-method-badge">Metode Pembayaran: {{ $paymentMethod }}</div>
            ...
            <div class="pay-summary-row">
                ...
                <span class="value">{{ $shipping_method_display }}</span>
                @if($shipping_method == 'AMBIL_SENDIRI')
            ...
            <div class="pay-summary-row">
                ...
                <span class="value">-Rp{{ number_format($total_discount, 0, ',', '.') }}</span>
            </div>
            @endif
            ...
            <div class="pay-summary-row">
                ...
                @else
                    <span class="value">Rp{{ number_format($shipping, 0, ',', '.') }}</span>
                @endif
            </div>
            ...
            <div class="pay-summary-row total">
                ...
                <span class="value">Rp{{ number_format($totalAmount, 0, ',', '.') }}</span>
            </div>
        </div>
            ...
            <div class="pay-product-list">
                @forelse($orderItems as $item)
                    ...
                    <div class="pay-product-item">
                        <img src="{{ asset($productImage) }}" alt="{{ $productName }}" class="pay-product-image" onerror="this.src='{{ asset('images/product-placeholder.jpg') }}'">
                        <div class="pay-product-info">
                            <div class="pay-product-name">{{ $productName }}</div>
                            <div class="pay-product-price">{{ $quantity }} x Rp{{ number_format($productPrice, 0, ',', '.') }}</div>
                        </div>
                        <div class="pay-product-total">
                            @if($hasDiscount)
                                <span class="price-strikethrough">Rp{{ number_format($originalPrice, 0, ',', '.') }}</span>
                ...
                @empty
                    <div class="pay-product-item">
                        <img src="{{ asset('images/product-placeholder.jpg') }}" alt="Produk" class="pay-product-image">
                        <div class="pay-product-info">
            ...
            <div class="pay-steps">
                ...
                <ul class="pay-steps-list">
                    @if($paymentMethodCode == 'QRIS')
                        ...
                        <li class="pay-steps-item">Pastikan nominal pembayaran sesuai dengan total tagihan Rp{{ number_format($totalAmount, 0, ',', '.') }}.</li>
                    ...
                    @elseif($paymentMethodCode == 'CASH' || $paymentMethodCode == 'COD_QRIS')
                        <li class="pay-steps-item">Siapkan uang tunai sesuai dengan total tagihan Rp{{ number_format($totalAmount, 0, ',', '.') }}.</li>
        ...
        @if(strtoupper($paymentStatus) === 'WAITING_PAYMENT')
            <div class="pay-upload-section">
                ...
                <form id="payment-form" action="{{ route('user.payments.confirm', $orderCode) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="pay-buttons">
                        <a href="{{ route('user.orders.index') }}" class="pay-button pay-button-secondary">
        ...
        @else
            <div class="pay-buttons">
                <a href="{{ route('user.products.index') }}" class="pay-button pay-button-secondary" style="flex: 1;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                        <path d="M19 12H5M12 19l-7-7 7-7"></path>
                    </svg>
                    Kembali ke Produk
                ...
                <a href="{{ route('user.orders.index') }}" class="pay-button pay-button-primary">
